<?php
/*
Plugin Name: [OLD] CBX Multi Criteria Rating & Review System
...
define('CB_RATINGSYSTEM_PLUGIN_VERSION', '3.9.5'); //need for checking verson
...
defined('CB_RATINGSYSTEM_PATH') or define('CB_RATINGSYSTEM_PATH', plugin_dir_path(__FILE__));
defined('CB_RATINGSYSTEM_URL') or define('CB_RATINGSYSTEM_URL', plugin_dir_url(__FILE__));
