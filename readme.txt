=== [OLD] CBX Multi Criteria Rating & Review System ===
...
[Old Version] Multi Criteria Rating & Review System for wordpress

== Description ==

>Please note that, we have abandoned this plugin's new development but good news is we have released totally fresh new plugin for same purpose but with more robust and modern features that possible for any rating plugin in recent time. Try the NEW [Multi Criteria Rating and Review Plugin](https://wordpress.org/plugins/cbxmcratingreview/) We have provided [migration](https://codeboxr.com/old-cbx-multi-criteria-rating-review-plugin-data-migration-to-new/) feature in the new plugin so that old plugin's forms and rating/reviews can be migrated to new one. [Learn more details about new Multi Criteria Rating plugin](https://codeboxr.com/product/cbx-multi-criteria-rating-review-for-wordpress/) and [New plugin Documentation](https://codeboxr.com/documentation-for-cbx-multi-criteria-rating-review-for-wordpress/). We request ignore this old version and install new or migrate to new version so that we can provide any new feature easily in future as you need.


If you want to try more Simplistic Single Criteria Rating and Review Plugin with near same feature [try our another plugin](https://wordpress.org/plugins/cbxscratingreview/)
...
== Changelog ==
= 3.9.4 =
* [Bug fix] SQL query prepare warning issue fix
* [Bug fix] Other Minor bug fix, pro addon has update with this core plugin update
